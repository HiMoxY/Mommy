...
const cuttweet = [
     ...
     '❔questions : Why can magicians make things disappear into thin air, but not thick air?',
     '❔questions : Why is it that rain drops but snow falls?',
     '❔questions : Why is the third hand on the watch called second hand?',
     ...
     '❔questions : If you tell someone they are being judgmental aren it you being judgmental yourself?',
     '❔questions : Why do they call it a Running Back when he is running forward?',
     ...
     '❔questions : Why do the numbers on a phone go one way and the numbers on the calculator go the other?',
     '❔questions : Why do donuts have holes?',
     '❔questions : Why doesn t Tarzan have a beard?',
     '❔questions : Have you ever wondered why Trix are only for kids?',
     '❔questions : Why do you click on start to exit Microsoft Windows?',
     ...
     '❔questions : Are zebras black with white stripes, or white with black stripes?',
     '❔questions : Did they have antiques in the olden days?',
     '❔questions : Why are pennies bigger than dimes?',
     ...
     '❔questions : Why does Goofy stand erect while Pluto remains on all fours? They are both dogs!',
     '❔questions : If you try to fail and succeed, what did you just do?',
     '❔questions : Is the opposite of  out of whack' "in whack"',
     '❔questions : Why are toe nail clippers bigger than finger nail clippers when your toe nails are smaller than your finger nails?',
     '❔questions : If practice makes perfect, and nobody is perfect, then why practice?',
     '❔questions : What is the opposite of opposite?',
     '❔questions : Why do we scrub down and "wash up"?',
]
